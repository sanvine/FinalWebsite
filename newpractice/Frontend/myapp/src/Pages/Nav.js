...
const Nav = () => {
    ...
    const handleSubmit=(e)=>{
        e.preventDefault()
        axios.post('https://code-tech-nrf1.onrender.com/api/v1/applicationpath',{name,email,password,phone})
        .then((result)=>{
            console.log(result)
    ...
    const handleSubmit1=(e)=>{
        e.preventDefault()
        axios.post('https://code-tech-nrf1.onrender.com/api/v1/login',{email:email1,password:password1})
        .then((result)=>{
            console.log(result)
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                                <a class="nav-link me-5 active" href="/courses" role="button">
                                    COURSES
                                </a>
                        </li>
                        </Link>
                        ...
                        <li class="nav-item">
                            <a href='##' class="nav-link me-5 active">CONTACT</a>
                        </li>
                        </Link>
                        <li class="nav-item">
                            <button type='button' class='btn nav-btn rounded me-5 mt-1' data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Login</button>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <Link to='/'>
                            <button data-bs-dismiss="modal" className='btn btn-default rounded w-100 bg-secondary text-decoration-none'>Return Home</button>
                        </Link>
                    </div>
                </div>
            </div>
